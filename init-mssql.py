...
'''
# -----------------------------------------------------------------------------
# init-mssql initializes a MS SQL database for use with Senzing.
#   - Creates the schema (tables, indexes, etc.)
#   - Inserts initial Senzing configuration
#   - init-mssql.py is idempotent.  It can be run repeatedly.
# -----------------------------------------------------------------------------
'''
...
CONFIGURATION_LOCATOR = {
    ...
    "input_sql_url": {
        "default": "/opt/senzing/g2/resources/schema/g2core-schema-mssql-create.sql",
...
def get_parser():
    ...
    parser = argparse.ArgumentParser(prog="init-mssql.py", description="Add description. For more information, see https://github.com/Senzing/init-mssql")
